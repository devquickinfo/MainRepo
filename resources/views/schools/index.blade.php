                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <form action="{{ route('schools.destroy', $school) }}" method="POST" class="d-inline">
                          ...
                          @method('DELETE')
                          <button type="submit"
                                  class="btn btn-sm {{ $school->status ? 'btn-success' : 'btn-danger' }}"
                                  onclick="return confirm('{{ $school->status ? 'Deactivate' : 'Activate' }} this school?')">
                      ...
                      <form action="{{ route('schools.destroy', $school) }}" method="POST" class="d-inline">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('Delete this school permanently?')">
