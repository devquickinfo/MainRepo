          ...
          @if($user->role === 'school')
            <div class="col-12">
              <div class="alert alert-info">
                <h4 class="alert-heading">School Overview</h4>
                <p class="mb-0">{{ $school?->school_name ?? 'School' }} is managing the current academic records.</p>
              </div>
            </div>
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number">{{ $school?->school_name ?? 'N/A' }}</span>
                </div>
              </div>
            </div>
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number">{{ $classes ?? 0 }}</span>
                </div>
              </div>
            </div>
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number">{{ $sections ?? 0 }}</span>
                </div>
              </div>
            </div>
            <div class="col-12 col-sm-6 col-md-3">
          ...
          @else
            <div class="col-12">
              <div class="alert alert-success">
                <h4 class="alert-heading">System Overview</h4>
                <p class="mb-0">Superadmin can manage schools, classes, sections, and students from one place.</p>
              </div>
            </div>
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box">
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Classes</span>
                  <span class="info-box-number">{{ $classesCount ?? 0 }}</span>
                </div>
              </div>
            </div>
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Sections</span>
                  <span class="info-box-number">{{ $sectionsCount ?? 0 }}</span>
                </div>
              </div>
            </div>
            <div class="col-12 col-sm-6 col-md-3">
