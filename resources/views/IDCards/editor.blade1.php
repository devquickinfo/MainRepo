...
<div class="editor">
  ...
  <div class="controls" id="controlsPanel">
    ...
    <!-- SCHOOL LOGO -->
    <div class="group">
      <div class="group-title"><h3>School Logo</h3><span class="chev">▾</span></div>
      <div class="group-body">
    ...
    <!-- SCHOOL NAME -->
    <div class="group">
      <div class="group-title"><h3>School Name</h3><span class="chev">▾</span></div>
      <div class="group-body">
    ...
    <!-- ADDRESS -->
    <div class="group">
      <div class="group-title"><h3>Address</h3><span class="chev">▾</span></div>
      <div class="group-body">
    ...
    <!-- SESSION -->
    <div class="group">
      <div class="group-title"><h3>Session</h3><span class="chev">▾</span></div>
      <div class="group-body">
    ...
    <!-- PRINCIPAL SIGNATURE -->
    <div class="group">
      <div class="group-title"><h3>Principal Signature</h3><span class="chev">▾</span></div>
      <div class="group-body">
...
(function(){
  ...
  const fields = [
    { key:'logo',   el:'elLogo',   x:'logoX',   y:'logoY',   w:'logoW',   h:'logoH' },
    { key:'schoolName', el:'elSchoolName', x:'schoolNameX', y:'schoolNameY', text:'schoolNameText', size:'schoolNameSize', color:'schoolNameColor', weight:'schoolNameWeight' },
    { key:'address', el:'elAddress', x:'addressX', y:'addressY', text:'addressText', size:'addressSize', color:'addressColor' },
    { key:'session', el:'elSession', x:'sessionX', y:'sessionY', text:'sessionText', size:'sessionSize', color:'sessionColor' },
    ...
    { key:'sign',   el:'elSign',   x:'signX',   y:'signY',   w:'signW',   h:'signH' },
